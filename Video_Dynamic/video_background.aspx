...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/styles.css" />
        ...
        <%--<link rel="stylesheet" href="http://localhost:80/resources/assets/client/client.css" media="all">--%>    
    <%--<link href="../../../../fonts/qlik-styles.css" rel="stylesheet" />--%>
        
       <!-- <script src="../../../../Source/require.js"></script>-->
        <script src="http://localhost:80/resources/assets/external/requirejs/require.js"></script>
    <link rel = "stylesheet" href="http://localhost:80/resources/autogenerated/qlik-styles.css">
          <link rel="stylesheet" href="http://localhost:80/resources/autogenerated/qlikui.css" />
    <link rel="stylesheet" href="http://localhost:80/resources/assets/client/client.css" media="all" />
      <link href="../../fonts/fonts.css" rel="stylesheet" />
    <script src="dynamic.js"></script>
      
    <style>
        .qvt-visualization-title{color:white; font-size:x-small;}
        .qvt-visualization-title.inner h1 {color:white; font-size:x-small;}
        .qv-chart-component qv-chart-component-axis qv-layout-medium.canvas{color:white; background:red;}
        .qvt-sheet {
  ...
  <body>
    ...
    <header id="first" style="overflow: auto;">
        <div class="header-content">
            <div class="inner" >
                
                <div style="float:left; width: 48%; min-width:350px; height: 400px; opacity:1; margin-left:auto; margin-right: auto; "  id="QV03" class="qvobject" data-qvid="JxjhqT"></div>
                <div style="float: left; width: 48%; min-width:350px; height: 400px; opacity:1;margin-left: 10px;"  id="myDiv1" class="qvobject" data-qvid="pJSx"></div>
        ...
        <video autoplay="" loop="" class="fillWidth fadeIn wow collapse in" data-wow-delay="0.5s" poster="https://s3-us-west-2.amazonaws.com/coverr/poster/Traffic-blurred2.jpg" id="video-background">
            <source src="css/up.mp4" type="video/mp4">Your browser does not support the video tag. I suggest you upgrade your browser.
