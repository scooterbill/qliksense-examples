<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Standard_JS.aspx.cs" Inherits="_Default" %>
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js"></script>
   ...
   <%--  
    ...
    <%--<script src="http://usrem-nak002.qliktech.com/resources/assets/external/requirejs/require.js"></script>--%>
    <link href="../../fonts/fonts.css" rel="stylesheet" />
    
    <script src="StandardJS.js"></script>
   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <%--  <div class='cs_description'>
        ...
        <div class='cs_play_pause' style="width: 100%">
           <%-- <label class='cs_play' for='cs_play1'>
            ...
            <div style="width: 900px; height: 500px; opacity:1; margin-left:auto; margin-right: auto;">
                <div style="float: left; width: 440px; height: 500px; opacity:1;  " id="myDiv" class="qvobject" data-qvid="GdjmWq"></div>
                <div style="float: left; width: 440px; height: 500px; opacity:1;margin-left: 10px;"  id="myDiv1" class="qvobject" data-qvid="pJSx"></div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div style="width: 900px; height: 500px; opacity:1; margin-left:auto; margin-right: auto;">
                <div style="float: left; width: 800px; height: 400px; opacity:1;  " id="myDiv" class="qvobject" data-qvid="vEAJLgj"></div>
...
Copy any changes made here over to the README too. -->
            <p>
                ...
                as well as compiled and minified
                 ...
                 CSS and JS (<code>bootstrap.min.*</code>). CSS
                ...
                Bootstrap theme.</p>
            <p>
                The Bootstrap source code download 
                includes the precompiled CSS, JavaScript, and
